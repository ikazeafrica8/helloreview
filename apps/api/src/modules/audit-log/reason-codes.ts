...
export const AUDIT_ACTION = {
  ...
  WORKFLOW_INCIDENT_CREATED: 'WORKFLOW_INCIDENT_CREATED',
...
export const PROTECTED_ACTIONS: ReadonlySet<string> = new Set<AuditAction>([
  ...
  AUDIT_ACTION.WORKFLOW_TRANSITION_REJECTED,
  AUDIT_ACTION.AUTOMATION_RESUMED,
  AUDIT_ACTION.WORKFLOW_INCIDENT_CREATED,
])
